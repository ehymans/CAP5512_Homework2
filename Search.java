	...
	//	Initialize RNG, array sizes and other objects
		...
		for (R = 1; R <= Parameters.numRuns; R++){
			...
			for (G=0; G<Parameters.generations; G++)
			{
				...
				//Hwrite.right((int)bestOfGenChromo.rawFitness, 3, summaryOutput);
				//Hwrite.right(averageRawFitness, 8, 3, summaryOutput);
				//Hwrite.right(stdevRawFitness, 8, 3, summaryOutput);
				//summaryOutput.write("\n");
